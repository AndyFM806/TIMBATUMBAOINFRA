      ...
      ##################################
      {
        ...
        properties = {
          metrics = [
            ...
            ["...", "4xx", "ApiId", local.api_gateway_id, { "stat" : "Sum", "label" : "Errores 4xx (Cliente)" }],
            ["...", "5xx", "ApiId", local.api_gateway_id, { "stat" : "Sum", "label" : "Errores 5xx (Servidor)" }]
          ]
          period = 60
          region = local.region
